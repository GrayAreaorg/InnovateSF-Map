...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('map_pendinglocation', (
            ...
            ('existing', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='revisions', null=True, to=orm['map.Location'])),
        ))
    ...
    models = {
        ...
        'map.pendinglocation': {
            'Meta': {'ordering': "['name']", 'object_name': 'PendingLocation', '_ormbases': ['map.Location']},
            'existing': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'revisions'", 'null': 'True', 'to': "orm['map.Location']"}),
            'location_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['map.Location']", 'unique': 'True', 'primary_key': 'True'})
        },
        'map.type': {
