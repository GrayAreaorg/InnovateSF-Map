...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.permalink'
        db.alter_column('map_location', 'permalink', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Location.permalink'
        db.alter_column('map_location', 'permalink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
