...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('map_location', 'created_by',
        ...
        db.alter_column('map_location', 'address', self.gf('django.db.models.fields.TextField')(default='San Francico'))

    def backwards(self, orm):
        # Deleting field 'Location.created_by'
        db.delete_column('map_location', 'created_by_id')


        # Changing field 'Location.address'
        db.alter_column('map_location', 'address', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'map.location': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'creator'", 'null': 'True', 'to': "orm['auth.User']"}),
